...
$C$DW$CU	.dwtag  DW_TAG_compile_unit
	.dwattr $C$DW$CU, DW_AT_name("../driverlib/MSP430F5xx_6xx/eusci_a_spi.c")
...
;	/opt/ti/ccsv6/tools/compiler/ti-cgt-msp430_4.4.3/bin/opt430 /tmp/089543ybO83 /tmp/08954uVZQhH 
...
$C$DW$T$61	.dwtag  DW_TAG_typedef, DW_AT_name("__builtin_va_list")
	...
	.dwattr $C$DW$T$61, DW_AT_decl_file("../driverlib/MSP430F5xx_6xx/eusci_a_spi.c")
