...
;	/opt/ti/ccsv6/tools/compiler/ti-cgt-msp430_4.4.3/bin/opt430 /tmp/04398WQF61J /tmp/04398k52aqp 
...
$C$DW$T$61	.dwtag  DW_TAG_typedef, DW_AT_name("__builtin_va_list")
	...
	.dwattr $C$DW$T$61, DW_AT_decl_file("../driverlib/MSP430F5xx_6xx/ldopwr.c")
